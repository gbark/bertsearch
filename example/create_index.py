...
def main(args):
    ...
    # delete all indices from elasticssearch instance matching index_name
    # client.indices.delete(index=args.index_name, ignore_unavailable=true})
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--index_file", default="index.json", help="Elasticsearch index file."
    )
    parser.add_argument(
